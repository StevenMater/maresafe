    ...
    <>
      <div className="flex flex-col xs:flex-row gap-2 w-full sm:w-auto">
        <button
          ...
          className="inline-flex xs:flex-1 sm:flex-none items-center justify-center gap-1.75 bg-navy2 hover:bg-navy text-white text-xs font-bold rounded py-2 px-4 border-none cursor-pointer transition-colors"
        >
          <FolderOpen size={14} />
          {t("btn_load")}
        </button>
        <button
          ...
          className="inline-flex xs:flex-1 sm:flex-none items-center justify-center gap-1.75 bg-red hover:bg-red/80 text-white text-xs font-bold rounded py-2 px-4 border-none cursor-pointer transition-colors"
        >
          <Trash2 size={14} />
          {t("btn_clear")}
        </button>
