Commit all staged and unstaged changes as grouped, individually-revertable
commits using conventional commit format.
...
- Use conventional commit format: `type(scope): description`
  - Types: `feat`, `fix`, `chore`, `refactor`, `style`, `docs`, `test`, `ci`,
    `perf`
  - Scope is optional but preferred when it names the affected area (e.g.
    `feat(pdf): ...`, `fix(auth): ...`)
